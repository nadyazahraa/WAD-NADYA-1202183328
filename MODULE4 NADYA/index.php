...
<head>
    ...
    <title>INDEX-beauty</title>
</head>

<body>

    <!-- navbar start here -->
    <nav class="navbar navbar-expand-lg navbar-light bg-light text-dark justify-content-between">
    ...
    if($id == "1"){
        ...
        if($database->insert($user_id,$nama_barang,$harga)) {
                ...
                <div class="card-group">
                    <div class="card" style="background-image: linear-gradient(to right, #4CDDDA , #96E4B4, #F4EA88);">
                        <div class="card-body" align="center">
                            <h1 class="display-4" style="color: white;">WAD Beauty</h1>
                            <p class="lead" style="color: white;"><b>Tersedia Skin Care dengan harga murah tapi bukan murahan dan berkualitas</b></p>
                        </div>
                    </div>
                </div>
                <div class="card-group">
                    <div class="card">
                        <img class="card-img-top img-fluid" src="yuja niacin.jpg" alt="Yuja Niacin 30 Days Blemish Care Serum">
                        <div class="card-body">
                    ...
                    <div class="card">
                        <img class="card-img-top img-fluid" src="snail truecica.jpg" alt="Snail Truecica Miracle Repair Cream">
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                    ...
                    <div class="card">
                        <img class="card-img-top img-fluid" src="miracle toner.jpg" alt="30 Days Miracle Toner">
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
